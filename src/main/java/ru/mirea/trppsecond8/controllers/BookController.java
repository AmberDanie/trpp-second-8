...
public class BookController {
    ...
    public BookController() {
        bookList = new CsvToBeanBuilder<Book>(new InputStreamReader(Objects.requireNonNull(this.getClass().getResourceAsStream("/MOCK_DATA.csv")))).withType(Book.class).build().parse();
    }
